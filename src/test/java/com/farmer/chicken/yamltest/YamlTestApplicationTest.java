...
/**
 * tips:
 * 下面方法注解中的resources换成你本地yml文件的绝对路径
 * 或
 * yml文件在classpath中的相对路径（推荐）
 */
...
public class YamlTestApplicationTest {
     ...
     * @param nl
     */
    @YmlFileSource(resources = {
            "D:/GitProjects/yaml-test-farmer/src/main/resources/YamlTest.yml",
            "D:/GitProjects/yaml-test-farmer/src/test/resources/YamlTest.yml",
            "D:/GitProjects/yaml-test-farmer/target/test-classes/YamlTest.yml"})
    public void test(
            /**基础类型*/
            String orderId,
            Integer id,
     ...
     * @param h
     */
    @YmlFileSource(resources = {"module1/basicAndPackageType1.yml"})
     ...
     */
    @YmlFileSource(resources = {"DateType1.yml", "DateType1.yml"})
